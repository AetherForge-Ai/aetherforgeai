...
2. An internet connection (needed to fetch live prices)
3. **Node.js 18 or newer** (free)
...
### Linux
Use your package manager, or download the LTS build from [https://nodejs.org](https://nodejs.org).
...
1. Unzip the file you received (e.g. `AetherForge-Stox-FullEngine-v1.0.zip` or `AetherForge-Koins-FullEngine-v1.0.zip`)
2. Put the folder somewhere easy to find, for example:
...
3. Pull price history where available
4. Run the full technical engine on every holding
5. Write a professional HTML report into the `output/` folder
...
1. Open the `output` folder inside your package
2. Double-click the newest `.html` file
3. It will open in your normal web browser
