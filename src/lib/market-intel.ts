...
export interface NewsItem {
  ...
  url: string;
  /** Optional hero image for the story. */
  imageUrl?: string;
}

const NEWS_POOL: NewsItem[] = [
  { headline: "RBNZ holds the OCR at 3.25%; forward guidance turns dovish on cooling inflation", source: "NZ Markets Daily", market: "NZX", impact: "Bullish", relevance: 96, time: "2h ago" , summary: "The Reserve Bank of New Zealand left the Official Cash Rate unchanged at 3.25%, while signalling a more dovish path as inflation cools toward the target band. Local banks and rate-sensitive NZX names firmed on the guidance shift, with investors pricing a higher chance of cuts later in the cycle.", url: "https://www.rbnz.govt.nz/", imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=80" },  { headline: "Fonterra lifts farmgate milk-price forecast, buoying NZX dairy exposure", source: "BusinessDesk", market: "NZX", impact: "Bullish", relevance: 88, time: "4h ago" , summary: "Fonterra raised its farmgate milk-price forecast, lifting sentiment across NZX dairy and rural-service exposures. Stronger global dairy commodity prices and steady Chinese demand underpinned the upgrade, supporting cash-flow expectations for supplier shareholders.", url: "https://www.fonterra.com/nz/en.html", imageUrl: "https://images.unsplash.com/photo-1628088062854-d1870b4553da?auto=format&fit=crop&w=1200&q=80" },  { headline: "Fisher & Paykel Healthcare guides FY revenue above consensus on hospital demand", source: "NZX Wire", market: "NZX", impact: "Bullish", relevance: 84, time: "5h ago" , summary: "Fisher & Paykel Healthcare guided full-year revenue above consensus, citing resilient hospital demand for respiratory and acute-care products. The outlook reinforced FPH's premium positioning on the NZX healthcare complex.", url: "https://www.fphcare.com/", imageUrl: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1200&q=80" },  { headline: "ASX resources rally as iron-ore firms above US$105/t on China stimulus", source: "ASX Wire", market: "ASX", impact: "Bullish", relevance: 82, time: "3h ago" , summary: "ASX resources stocks advanced as iron-ore prices held above US$105 a tonne on fresh China stimulus expectations. Miners with leveraged exposure to steelmaking inputs led the session, lifting the materials weighting in the ASX 200.", url: "https://www.asx.com.au/", imageUrl: "https://images.unsplash.com/photo-1581094794329-c8112c4e5190?auto=format&fit=crop&w=1200&q=80" },  { headline: "Commonwealth Bank flags stable margins but cautious consumer outlook", source: "AFR", market: "ASX", impact: "Neutral", relevance: 78, time: "6h ago" , summary: "Commonwealth Bank reported stable net interest margins but flagged a cautious consumer backdrop. Markets treated the update as neutral \u2014 solid franchise quality offset by softer household credit demand.", url: "https://www.commbank.com.au/", imageUrl: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&q=80" },  { headline: "Woodside Energy signs long-term LNG supply deal with Asian utility", source: "Reuters", market: "ASX", impact: "Bullish", relevance: 71, time: "7h ago" , summary: "Woodside Energy signed a long-term LNG supply agreement with an Asian utility, extending contracted volumes and supporting cash-flow visibility. Energy peers on the ASX tracked higher on the deal news.", url: "https://www.woodside.com/", imageUrl: "https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&w=1200&q=80" },  { headline: "US CPI prints cooler than expected; rate-cut odds for the next FOMC firm up", source: "Bloomberg", market: "US", impact: "Bullish", relevance: 90, time: "1h ago" , summary: "US consumer inflation printed cooler than expected, lifting market odds of Federal Reserve rate cuts at upcoming FOMC meetings. Risk assets globally responded positively, with rate-sensitive growth names leading.", url: "https://www.bls.gov/cpi/", imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&w=1200&q=80" },  { headline: "NVIDIA data-centre backlog extends; AI capex cycle shows no sign of peaking", source: "CNBC", market: "US", impact: "Bullish", relevance: 68, time: "8h ago" , summary: "NVIDIA indicated its data-centre backlog remains extended as AI infrastructure spending shows little sign of peaking. Chip and software suppliers leveraged to GPU demand continued to outperform broader indices.", url: "https://www.nvidia.com/", imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1200&q=80" },  { headline: "NZD/USD strengthens toward 0.61 as risk sentiment improves globally", source: "FX Observer", market: "Global", impact: "Neutral", relevance: 74, time: "2h ago" , summary: "The New Zealand dollar firmed toward 0.61 against the US dollar as global risk appetite improved. A softer greenback and firmer commodity prices supported the kiwi across Asian trade.", url: "https://www.rbnz.govt.nz/statistics", imageUrl: "https://images.unsplash.com/photo-1580519542036-c47de6196ba5?auto=format&fit=crop&w=1200&q=80" },  { headline: "Global funds rotate into APAC value names as US mega-cap valuations stretch", source: "Morningstar", market: "Global", impact: "Bullish", relevance: 70, time: "9h ago" , summary: "Global managers rotated toward Asia-Pacific value names as US mega-cap valuations stretched further. Flows favoured banks, resources and industrials with clearer earnings visibility.", url: "https://www.morningstar.com/", imageUrl: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=1200&q=80" },  { headline: "Oil eases on demand concerns, pressuring energy-heavy ASX index weightings", source: "MarketWatch", market: "ASX", impact: "Bearish", relevance: 62, time: "10h ago" , summary: "Crude oil prices eased on demand concerns, pressuring energy-heavy weightings in the ASX. Integrated producers and oil-service names underperformed as forward curves softened.", url: "https://www.marketwatch.com/investing/future/cl.1", imageUrl: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1200&q=80" },  { headline: "Auckland Airport passenger volumes recover to 92% of pre-2020 levels", source: "NZ Herald", market: "NZX", impact: "Bullish", relevance: 66, time: "11h ago" , summary: "Auckland Airport reported passenger volumes recovering to 92% of pre-2020 levels, supporting the tourism and travel recovery narrative on the NZX. Retail concession and aeronautical revenue trends remained constructive.", url: "https://corporate.aucklandairport.co.nz/", imageUrl: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&q=80" },];

const CRYPTO_NEWS_POOL: NewsItem[] = [
  { headline: "Spot Bitcoin ETFs log record weekly net inflows as institutional demand accelerates", source: "CoinDesk", market: "CRYPTO", impact: "Bullish", relevance: 95, time: "1h ago" , summary: "US spot Bitcoin ETFs recorded a record weekly haul of net inflows as institutional desks added exposure. BTC liquidity and futures basis reflected stronger demand across major venues.", url: "https://www.coindesk.com/", imageUrl: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fit=crop&w=1200&q=80" },  { headline: "Ethereum staking yield firms above 4% as validator queue clears post-upgrade", source: "The Block", market: "CRYPTO", impact: "Bullish", relevance: 88, time: "2h ago" , summary: "Ethereum staking yields held above 4% as the validator queue cleared following network upgrades. On-chain activity and L2 settlement volumes supported a constructive ETH medium-term setup.", url: "https://www.theblock.co/", imageUrl: "https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=1200&q=80" },  { headline: "Solana network hits new daily transaction high; DeFi TVL rotates higher", source: "Blockworks", market: "CRYPTO", impact: "Bullish", relevance: 84, time: "3h ago" , summary: "Solana posted a fresh daily transaction high while DeFi TVL rotated higher into SOL-ecosystem protocols. Throughput gains and lower fees kept activity elevated versus peer L1s.", url: "https://blockworks.co/", imageUrl: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=1200&q=80" },  { headline: "Bitcoin funding rates cool from overheated levels, easing squeeze risk", source: "Glassnode", market: "CRYPTO", impact: "Neutral", relevance: 80, time: "4h ago" , summary: "Perpetual funding rates on Bitcoin cooled from overheated levels, reducing near-term squeeze risk. Positioning data suggested a healthier balance between longs and shorts.", url: "https://glassnode.com/", imageUrl: "https://images.unsplash.com/photo-1621416894569-0f39ed31d247?auto=format&fit=crop&w=1200&q=80" },  { headline: "US regulator signals clearer digital-asset custody framework for banks", source: "Reuters", market: "CRYPTO", impact: "Bullish", relevance: 82, time: "5h ago" , summary: "US regulators signalled a clearer custody framework for banks handling digital assets, a constructive step for institutional crypto infrastructure. Custody and brokerage names caught a bid on the headlines.", url: "https://www.reuters.com/", imageUrl: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80" },  { headline: "Stablecoin market cap expands as on-chain settlement volumes climb", source: "Kaiko", market: "CRYPTO", impact: "Bullish", relevance: 74, time: "6h ago" , summary: "Stablecoin market capitalisation expanded as on-chain settlement volumes climbed. Dollar-pegged tokens remained the primary bridge for crypto market liquidity.", url: "https://www.kaiko.com/", imageUrl: "https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=1200&q=80" },  { headline: "Layer-2 activity surges; Arbitrum and Optimism fees drop on throughput gains", source: "L2Beat", market: "CRYPTO", impact: "Bullish", relevance: 70, time: "7h ago" , summary: "Layer-2 networks saw activity surge while fees on Arbitrum and Optimism fell on throughput gains. Cheaper settlement kept retail and DeFi flows on L2 rails.", url: "https://l2beat.com/", imageUrl: "https://images.unsplash.com/photo-1639322537504-6427a16b0a28?auto=format&fit=crop&w=1200&q=80" },  { headline: "Long-dormant BTC supply stays put — long-term holder conviction intact", source: "CryptoQuant", market: "CRYPTO", impact: "Bullish", relevance: 72, time: "8h ago" , summary: "Long-dormant Bitcoin supply remained largely unmoved, consistent with strong long-term holder conviction. On-chain cohort analysis showed limited distribution from older coins.", url: "https://cryptoquant.com/", imageUrl: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fit=crop&w=1200&q=80" },  { headline: "Macro: softer US dollar and cooling yields lift risk appetite across digital assets", source: "Bloomberg", market: "Global", impact: "Bullish", relevance: 78, time: "2h ago" , summary: "A softer US dollar and cooling yields lifted risk appetite across digital assets. Correlation with broader equity beta rose as liquidity conditions improved.", url: "https://www.bloomberg.com/", imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=80" },  { headline: "Options desks note elevated BTC implied volatility into month-end expiry", source: "Deribit Insights", market: "CRYPTO", impact: "Neutral", relevance: 64, time: "9h ago" , summary: "Options desks flagged elevated Bitcoin implied volatility into month-end expiry. Skew pointed to demand for downside protection even as spot held firm.", url: "https://www.deribit.com/", imageUrl: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?auto=format&fit=crop&w=1200&q=80" },  { headline: "Memecoin froth cools as capital rotates toward large-cap majors", source: "Messari", market: "CRYPTO", impact: "Bearish", relevance: 58, time: "10h ago" , summary: "Memecoin froth cooled as speculative capital rotated back toward large-cap majors. Liquidity migrated into BTC and ETH pairs on major exchanges.", url: "https://messari.io/", imageUrl: "https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=1200&q=80" },  { headline: "Corporate treasuries add BTC to balance sheets, citing diversification", source: "CoinTelegraph", market: "CRYPTO", impact: "Bullish", relevance: 68, time: "11h ago" , summary: "Additional corporate treasuries disclosed Bitcoin purchases, citing diversification and long-horizon reserve strategy. The headlines supported institutional adoption narratives.", url: "https://cointelegraph.com/", imageUrl: "https://images.unsplash.com/photo-1621416894569-0f39ed31d247?auto=format&fit=crop&w=1200&q=80" },];

/**
 * Curated fallback / client-safe news. Ages are derived from the UTC day so
 * the feed rotates daily with real-looking relative times (not hardcoded
 * "2h ago"). Live headlines come from `loadMarketNews` in market-news.ts
 * via GET /api/market.
 */
function relativeFromHoursAgo(hoursAgo: number): string {
...
export function getMarketNews(assetClass: AssetClass = "stock"): NewsItem[] {
  ...
  // Day bucket in Pacific/Auckland (~UTC+12) so NZ-local midnights drive rotation.
  const day = Math.floor((Date.now() + 12 * 60 * 60 * 1000) / 86_400_000);
  const rotated = [...pool]
    .map((item, i) => {
      // Stable per-day permutation + staggered ages (1h … ~36h).
      const ord = (i * 7 + day * 3) % pool.length;
      const hoursAgo = 1 + ((day + i * 5) % 36);
      return { item: { ...item, time: relativeFromHoursAgo(hoursAgo) }, ord };
    })
    .sort((a, b) => a.ord - b.ord || b.item.relevance - a.item.relevance)
    .map((x) => x.item);
  return rotated;
}
